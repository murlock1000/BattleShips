...
void disconnect(int registeredPlayers, HANDLE fdOutput[], HANDLE fdInput[], int pid[], bool playerType[], DBconnector& dbc, int lobbyId) { //Terminates connections
...
int sendError(DBconnector& dbc, int lobbyId, int timeout, int playerNumber, HANDLE fdOutput[], HANDLE fdInput[], int pid[], bool playerType[], int registeredPlayers, int playerId[], bool isPlayerConnected[]);

int waitForUserResponse(DBconnector& dbc, int lobbyId, int timeout, int playerNumber, HANDLE fdOutput[], HANDLE fdInput[], int pid[], bool playerType[], int registeredPlayers, int playerId[], bool isPlayerConnected[], int currentPlayer) {
...
int finishGame(DBconnector& dbc, int lobbyId, int timeout, int playerNumber, HANDLE fdOutput[], HANDLE fdInput[], int pid[], bool playerType[], int registeredPlayers, int playerId[], int historyId, bool isPlayerConnected[]) {
	for (int i = 0; i < playerNumber; i++) {
		if (!playerType[i]) {
...
int main(int argc, char* argv[]) {
	...
	*/
	...
	bool* isPlayerConnected = new bool[playerNumber];
	...
	for (int i = 0; i < playerNumber; i++) {
		...
		if (playerType[i]) { //ai initialisation
			...
			string aiName = userInfo.username + ".exe";
